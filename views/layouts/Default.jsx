      ...
      <html>
        ...
        <body>
          <div className='container'>
            ...
            <div className='address'>Address  <input type='text' className='addressField' placeholder='http://localhost:3000/blogs/' /></div>
            <div className='mySpaceWebpage'>
              <div className='mySpaceHeader'>MySpace.com   |  Home  <input type='text' /><button>Search</button></div>
